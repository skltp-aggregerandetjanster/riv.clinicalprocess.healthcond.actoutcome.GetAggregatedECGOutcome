...
public class GetAggregatedECGOutcomeTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedECGOutcome-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedECGOutcomeTeststubMuleServer.class);
